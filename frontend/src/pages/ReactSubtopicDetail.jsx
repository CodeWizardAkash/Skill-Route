...
import { reactTopicsContent } from "../data/reactTopicsContent";
...
export default function ReactSubtopicDetail() {
  const { topicId, subtopicId } = useParams();
  const topic = reactLearningPath.topics.find((t) => t.id === topicId);
  const content = reactTopicsContent[topicId]?.[subtopicId];
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-white transition-colors">
      <div className="max-w-4xl mx-auto p-4 md:p-10">
        ...
        >
          <span className="mr-2">&lt;-</span> Back to React Basics
        </Link>
